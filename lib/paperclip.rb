...
module Paperclip
  ...
  # Tempfiles which are generated by Paperclip within the given
  # block will be closed immediatly after contents haven been copied
  # and the file handler has been rewind.
  #
  # If attachments are assigned within big batch operations, the
  # running process is at risk to reach its upper limit of
  # open file descriptors. To migitate this potential problem
  # encapsulate the operation in a block and pass it to this method.
  #
  #     Paperclip.close_and_reopen_tempfiles do
  #       execute_batch_operation
  #     end
  def self.close_and_reopen_tempfiles(&block)
    Thread.current[:paperclip_close_and_reopen_tempfiles] = true
    yield
    Thread.current[:paperclip_close_and_reopen_tempfiles] = false
  end
